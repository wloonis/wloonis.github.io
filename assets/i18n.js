...
const I18N_EN = {
  ...
  "shot.dashboard": `Dashboard — aggregated counters and sessions`,
  "shot.counter": `Live counter — net bidirectional counter in real time`,
  "shot.session": `Session — detail (counters, duration, clips)`,
  "shot.history": `History — list of recorded clips`,
  "shot.detail": `Clip detail — playing a recorded video`,
  "shot.settings1": `Settings — Jetson connection + time sync`,
  "shot.settings2": `Settings — classes, line, counting direction`,
  "shot.settings3": `Settings — visual mask-zone editor`,
