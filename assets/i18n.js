...
const I18N_EN = {
  ...
  "ph.app.label": `📸 App screenshot — to add`,
  ...
  "gal.h2": `Gallery`,
  "gal.lede": `Placeholders prepared for videos and photos to add later. Each slot shows the expected file path in <code>assets/</code>.`,
  "gal.1.label": `🖼️ Photo — counting in action`,
  "gal.1.fig": `Yellow counting line + net counter overlay`,
  "gal.2.label": `🖼️ Photo — mask zones`,
  "gal.2.fig": `Semi-transparent overlay of excluded zones`,
  "gal.3.label": `🎬 Video — crossings`,
  "gal.3.fig": `Auto-recorded clip: animals crossing the line`,
  "gal.4.label": `🎬 Video — multi-species`,
  "gal.4.fig": `Configurable counting (human + pig)`,
  "gal.5.label": `🖼️ Photo — free slot`,
  "gal.5.fig": `To be defined`,
  "gal.6.label": `🎬 Video — free slot`,
  "gal.6.fig": `To be defined`,
  "gal.note": `The <code>assets/photos/</code> and <code>assets/videos/</code> folders exist (empty). Drop files there, then uncomment the matching <code>&lt;img&gt;</code> / <code>&lt;video&gt;</code> tag in <code>index.html</code> (the HTML comments show the exact markup).`,
